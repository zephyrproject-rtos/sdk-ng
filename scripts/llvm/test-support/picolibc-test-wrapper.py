...
disabled_tests = [
    ...
    "picolibc_rv64imafdc_zicsr_zifencei_zba_zbb_zbc_zbs_lp64d_exn_rtti-build/test/math_errhandling",
    "picolibc_rv64imafdc_zicsr_zifencei_zba_zbb_zbc_zbs_lp64d_exn_rtti-build/test/test-fma",
