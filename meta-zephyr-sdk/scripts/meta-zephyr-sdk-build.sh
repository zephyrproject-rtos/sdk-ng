...
export ZEPHYR_SDK_QEMU_ESPRESSIF_SRCREV=$(cd qemu_espressif; git rev-parse HEAD)
export BB_ENV_PASSTHROUGH_ADDITIONS="${BB_ENV_PASSTHROUGH_ADDITIONS} ZEPHYR_SDK_QEMU_ESPRESSIF_SRCREV"
