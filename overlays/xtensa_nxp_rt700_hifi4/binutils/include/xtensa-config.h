...
#define XCHAL_DCACHE_SIZE		65536

#undef XCHAL_ICACHE_LINESIZE
#define XCHAL_ICACHE_LINESIZE		256

#undef XCHAL_DCACHE_LINESIZE
#define XCHAL_DCACHE_LINESIZE		256

#undef XCHAL_ICACHE_LINEWIDTH
#define XCHAL_ICACHE_LINEWIDTH		8

#undef XCHAL_DCACHE_LINEWIDTH
#define XCHAL_DCACHE_LINEWIDTH		8
